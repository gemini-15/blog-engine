...
const Footer = () => {
    return (
        <div className="bg-secondary dark:bg-gray-800 p-4 sm:p-8 bottom-0 border-t border-gray-200 dark:border-gray-600 transition-colors duration-300">
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-4 sm:gap-0">
                ...
                <br /><br />
                © <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener noreferrer">License Creative Commons BY-SA 4.0</a> to Yassine Bargach
                </div>
