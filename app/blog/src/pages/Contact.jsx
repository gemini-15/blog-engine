...
export default function Contact() {
    ...
    return(
        <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 pt-20 mb-44 pb-24 bg-white dark:bg-gray-900 min-h-screen transition-colors duration-300">
            
            <div className="grid md:grid-cols-2 grid-cols-1 gap-8 space-y-6 md:space-y-0">
                ...
                <div>
                    <div className="flex">
                        <h1 className="text-black dark:text-gray-100 pb-5 font-extrabold text-2xl underline decoration-secondary hover:decoration-secondary">Whoami?</h1>
                    </div>
                    <div className="text-black dark:text-gray-100">
