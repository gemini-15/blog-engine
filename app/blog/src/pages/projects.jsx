...
export default function Projects() {
    ...
    return(
        <div className="min-h-screen w-full mb-40 pt-32 flex-grow bg-white dark:bg-gray-900 transition-colors duration-300">
            <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32">
                <div className="flex">
                    <h1 className="text-black dark:text-gray-100 font-extrabold text-2xl underline decoration-indigo-500 hover:decoration-indigo-800">
                        Minutes and notes taking 
                    </h1>
                </div>
                <div className="text-black dark:text-gray-100 mb-6">
